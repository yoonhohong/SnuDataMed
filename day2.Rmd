...
```{r, include=FALSE}
knitr::opts_chunk$set(collapse = T, eval = F)
```
...
R 기초와 데이터 타입, 데이터 구조    
[Basics of R](https://youtu.be/SWxoJqTqo08)      
[The basic data types in R](https://youtu.be/hxlHQ2AtLUk)     
[How to create and name vectors](https://youtu.be/w5dOALbZ9HE)     
[Using factors in R](https://youtu.be/xkRBfy8_2MU)      
[How to create and name matrices in R](https://youtu.be/O7KL17QZNqg)          
[Matrix arithmetic in R](https://youtu.be/GuZQZDCz4hA)      
[How to create and name lists in R](https://youtu.be/Px9VNWHja4M)       
[Using the data frame in R](https://youtu.be/9f2g7RN5N0I)      

R 프로그래밍    
[Working with for loops in R](https://youtu.be/h987LWDvqlQ)          
[while loop in R](https://youtu.be/kBjfWV8koMo)    
[How to use conditional statements in R](https://youtu.be/qvSKipqzg3U)    
